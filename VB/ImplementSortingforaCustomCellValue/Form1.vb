...
Namespace WindowsFormsApplication15
	Partial Public Class Form1
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			Me.salesPersonTableAdapter.Fill(Me.nwindDataSet.CustomerReports)
		...
		Private Sub FillFieldValues(ByVal isColumn As Boolean, ByVal count As Integer, ByVal fields As List(Of PivotGridField), ByVal data As PivotData)
			For i As Integer = 0 To count - 1
                ...
                Else
                    ...
                    val2 = i
                End If
                value.DataField = pivotGridControl1.Cells.GetCellInfo(val1, val2).DataField
		...
		Private Function GetSortByColumnIndex(ByVal e As PivotGridCustomFieldSortEventArgs) As Integer
			If sortInfo.Conditions.Count = 0 Then
				For i As Integer = pivotData.ColumnCount - 1 To 0 Step -1
                    ...
                    If Object.Equals(value.ValueType, PivotGridValueType.GrandTotal) AndAlso Object.Equals(value.DataField, sortInfo.DataField) Then
                        Return i
                    End If
                Next i
			Else
		...
		Private Function GetValueIndex(ByVal isColumn As Boolean, ByVal value As Object, ByVal field As PivotGridField, ByVal dataField As PivotGridField) As Integer
            ...
            If isColumn = True Then
                count = pivotData.ColumnCount
            Else
                count = pivotData.RowCount()
            End If
            For i As Integer = 0 To count - 1
        ...
        Private Sub pivotGridControl1_ShowMenu(ByVal sender As Object, ByVal e As PopupMenuShowingEventArgs) Handles pivotGridControl1.PopupMenuShowing
